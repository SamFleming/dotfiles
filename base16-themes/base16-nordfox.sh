...
color08="46/57/80" # Base 03 - Bright Black
...
color15="e7/ec/f4" # Base 07 - Bright White
color16="c9/82/6b" # Base 09
color17="bf/88/bc" # Base 0F
color18="39/40/4f" # Base 01
color19="44/4c/5e" # Base 02
color20="7e/81/88" # Base 04
color21="ab/b1/bb" # Base 06
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 444c5e # selection color
