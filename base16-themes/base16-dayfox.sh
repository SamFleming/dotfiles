...
# dayfox scheme by EdenEast
export BASE16_THEME=dayfox

color00="f6/f2/ee" # Base 00 - Black
color01="a5/22/2f" # Base 08 - Red
color02="39/68/47" # Base 0B - Green
color03="ac/54/02" # Base 0A - Yellow
color04="28/48/a9" # Base 0D - Blue
color05="6e/33/ce" # Base 0E - Magenta
color06="28/79/80" # Base 0C - Cyan
color07="3d/2b/5a" # Base 05 - White
color08="53/4c/45" # Base 03 - Bright Black
...
color15="f4/ec/e6" # Base 07 - Bright White
color16="95/5f/61" # Base 09
color17="a4/40/b5" # Base 0F
color18="db/d1/dd" # Base 01
color19="d3/c7/bb" # Base 02
color20="82/4d/5b" # Base 04
color21="64/3f/61" # Base 06
color_foreground="3d/2b/5a" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pi 3d2b5a # bold color
  put_template_custom Pj d3c7bb # selection color
  put_template_custom Pk 3d2b5a # selected text color
