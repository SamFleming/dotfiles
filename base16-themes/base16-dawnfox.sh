...
color15="e6/eb/f3" # Base 07 - Bright White
color16="d7/82/7e" # Base 09
color17="d6/85/af" # Base 0F
color18="eb/e0/df" # Base 01
color19="eb/df/e4" # Base 02
color20="a8/a3/b3" # Base 04
color21="62/5c/87" # Base 06
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj ebdfe4 # selection color
