...
# nightfox scheme by EdenEast
export BASE16_THEME=nightfox

color00="19/23/30" # Base 00 - Black
color01="c9/4f/6d" # Base 08 - Red
color02="81/b2/9a" # Base 0B - Green
color03="db/c0/74" # Base 0A - Yellow
color04="71/9c/d6" # Base 0D - Blue
color05="9d/79/d6" # Base 0E - Magenta
color06="63/cd/cf" # Base 0C - Cyan
color07="cd/ce/cf" # Base 05 - White
color08="57/58/60" # Base 03 - Bright Black
...
color15="e4/e4/e5" # Base 07 - Bright White
color16="f4/a2/61" # Base 09
color17="d6/7a/d2" # Base 0F
color18="21/2e/3f" # Base 01
color19="29/39/4f" # Base 02
color20="71/83/9b" # Base 04
color21="ae/af/b0" # Base 06
color_foreground="cd/ce/cf" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pi cdcecf # bold color
  put_template_custom Pj 29394f # selection color
  put_template_custom Pk cdcecf # selected text color
