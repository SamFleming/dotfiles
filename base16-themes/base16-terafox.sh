...
# terafox scheme by EdenEast
export BASE16_THEME=terafox

color00="15/25/28" # Base 00 - Black
color01="e8/5c/51" # Base 08 - Red
color02="7a/a4/a1" # Base 0B - Green
color03="fd/a4/7f" # Base 0A - Yellow
color04="5a/93/aa" # Base 0D - Blue
color05="ad/5c/7c" # Base 0E - Magenta
color06="a1/cd/d8" # Base 0C - Cyan
color07="e6/ea/ea" # Base 05 - White
color08="4e/51/57" # Base 03 - Bright Black
...
color16="ff/83/49" # Base 09
color17="cb/79/85" # Base 0F
color18="1d/33/37" # Base 01
color19="25/41/47" # Base 02
color20="58/7b/7b" # Base 04
color21="cb/d9/d8" # Base 06
color_foreground="e6/ea/ea" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg e6eaea # foreground
  put_template_custom Ph 152528 # background
  put_template_custom Pi e6eaea # bold color
  put_template_custom Pj 254147 # selection color
  put_template_custom Pk e6eaea # selected text color
  put_template_custom Pl e6eaea # cursor
